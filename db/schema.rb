...
ActiveRecord::Schema.define(version: 2019_01_26_191837) do
  ...
  create_table "counties_sample_units", id: false, force: :cascade do |t|
  ...
  create_table "sample_units_states", id: false, force: :cascade do |t|
    t.bigint "state_id", null: false
    t.bigint "sample_unit_id", null: false
    t.index ["sample_unit_id", "state_id"], name: "index_sample_units_states_on_sample_unit_id_and_state_id"
    t.index ["state_id", "sample_unit_id"], name: "index_sample_units_states_on_state_id_and_sample_unit_id"
  end
