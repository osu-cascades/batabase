...
ALTER TABLE "tluDatum" RENAME TO datums;
...
-----------------------------------------
 ...
 ALTER TABLE public.datums RENAME COLUMN "Label" TO label;
 ALTER TABLE public.datums RENAME COLUMN "ID" TO id;
 ALTER TABLE public.datums ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE datums ADD COLUMN updated_at timestamp without time zone;
ALTER TABLE datums ADD COLUMN created_at timestamp without time zone;
...
ALTER TABLE datums DROP CONSTRAINT "tluDatum_pkey";
...
ALTER TABLE datums ADD PRIMARY KEY (id);
...
CREATE SEQUENCE datums_id_seq OWNED BY datums.id;
...
SELECT setval('datums_id_seq', coalesce(max(id), 1)) FROM datums;
...
ALTER TABLE datums ALTER COLUMN id SET DEFAULT nextval('datums_id_seq');
