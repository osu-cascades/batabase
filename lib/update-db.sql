...
-----------------------------------------
 ...
 ALTER TABLE public.users RENAME COLUMN "MiddleInit" TO middle_init;
 ALTER TABLE public.users RENAME COLUMN "LastName" TO last_name;
 ALTER TABLE public.users RENAME COLUMN "YearsOfExperience" TO years_of_experience;
 ALTER TABLE public.users RENAME COLUMN "PositionTitle" TO position_title;
 ALTER TABLE public.users RENAME COLUMN "AddressType" TO address_type;
 ALTER TABLE public.users RENAME COLUMN "StateCode" TO state_code;
 ALTER TABLE public.users RENAME COLUMN "ZipCode" TO zip_code;
 ALTER TABLE public.users RENAME COLUMN "EmailAddress" TO email_address;
 ALTER TABLE public.users RENAME COLUMN "WorkPhone" TO work_phone;
 ALTER TABLE public.users RENAME COLUMN "WorkExtension" TO work_extension;
 ...
 ALTER TABLE public.users RENAME COLUMN "Initials" TO initials;
 ALTER TABLE public.users RENAME COLUMN "Organization" TO organization;
 ALTER TABLE public.users RENAME COLUMN "Address" TO address;
 ALTER TABLE public.users RENAME COLUMN "Address2" TO address_2;
 ALTER TABLE public.users RENAME COLUMN "Country" TO country;
 ALTER TABLE public.users RENAME COLUMN "City" TO city;
