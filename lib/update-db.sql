...
ALTER TABLE public.sample_units RENAME COLUMN "Images" TO image;
ALTER TABLE public.sample_units RENAME COLUMN "ParkCode" TO park_code;
ALTER TABLE public.sample_units RENAME COLUMN "SampleDesignID" TO sample_design_id;
ALTER TABLE public.sample_units RENAME COLUMN "SampleUnitID" TO sample_unit_id;
ALTER TABLE public.sample_units RENAME COLUMN "FederalAgency" TO federal_agency;
ALTER TABLE public.sample_units RENAME COLUMN "SiteDescription" TO site_description;
...
ALTER TABLE deployments DROP COLUMN "recording_start_date";
ALTER TABLE deployments DROP COLUMN "recording_start_time";
ALTER TABLE deployments DROP COLUMN "recording_stop_date";
ALTER TABLE deployments DROP COLUMN "recording_stop_time";
